...
public class ComparatorTest {
    ...
    public void testTitleAuthorComparator() {
        ...
        books.sort(new BookTitleComparator().thenComparing(new BookAuthorComparator()));
    ...
    public void testAuthorTitleComparator() {
        ...
        books.sort(new BookAuthorComparator().thenComparing(new BookTitleComparator()));
    ...
    public void testAuthorTitlePriceComparator() {
        ...
        books.sort(new BookAuthorComparator().thenComparing(new BookTitleComparator()).thenComparing(new BookPriceComparator()));
